...
- generated_at: 2026-07-18T10:51:29.833755+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **8936**

## 1. 今日の判断

- 結論: **実行可能なMARKET SHORTは安全条件未達。LIMIT/LONGはシャドウで測り、実行側対応まではlive portfolioへ流さない。**
- 全期間 MARKET基準: n=8936, expectancy=+0.01%
...
| LIMIT_1PCT_LONG | 13/20 | 65.0% | +0.60% | **+0.39%** |
...
- 確定: 3049件 (Win 946 / Loss 973 / Flat 1130) / skip 2448件
...
- 確定: 897件 (Win 215 / Loss 181 / Flat 501) / skip 1450件
...
- 最新: AKE/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account +0.00% 残高後 $110.97

## 5. Causal Adaptive DryRun ($100)

- 残高: **$99.07** / 初期 $100.00 (-0.93%)
- 確定: 191件 (Win 60 / Loss 104 / Flat 27) / pending 5件 / skip 216件
...
- 最新: AKE/USDT:USDT `MARKET` SL_HIT account -0.17% 残高後 $99.07

## 6. Latest Market Context

- 更新: 2026-07-18T10:51:20.451369+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h +0.03% price=63981.3
- Funnel: target 885 → liquid 167 → pre 50 → checked 50 → surge 4 → strict 1
- Surge前reject: below_1h_threshold=46, below_relative_strength=0, invalid_ohlcv=0, errors=0
- Strict後reject: 4h RSI 86.0 >= 65=1, 4h RSI 77.7 >= 65=1, 4h RSI 73.2 >= 65=1
...
| symbol | 24h | volume |
|---|---:|---:|
| AKE/USDT:USDT | +50.93% | $70,667,842.23 |
| B/USDT:USDT | +36.15% | $4,662,316.77 |
| TRADOOR/USDT:USDT | +28.30% | $4,591,503.40 |
| XEC/USDT:USDT | +18.94% | $3,595,870.75 |
| ALLO/USDT:USDT | +12.75% | $4,557,485.97 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| RAVE/USDT:USDT | below_1h_threshold | +4.71% | +4.67% |
| US/USDT:USDT | below_1h_threshold | +4.69% | +4.66% |
| BANK/USDT:USDT | below_1h_threshold | +4.07% | +4.04% |
| TRADOOR/USDT:USDT | below_1h_threshold | +2.08% | +2.05% |
| TRUMPOFFICIAL/USDT:USDT | below_1h_threshold | +1.69% | +1.65% |
