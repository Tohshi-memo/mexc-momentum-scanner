...
- generated_at: 2026-07-23T02:41:19.872426+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **9343**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +0.74% / filled 20/20。**
- 全期間 MARKET基準: n=9343, expectancy=-0.01%
...
| LIMIT_ATR_LONG | 16/20 | 80.0% | +0.26% | **+0.21%** |
| LIMIT_FIB1272_LONG | 9/20 | 45.0% | +0.16% | **+0.07%** |
...
- 確定: 3320件 (Win 1048 / Loss 1075 / Flat 1197) / skip 2584件
...
- 確定: 1161件 (Win 312 / Loss 254 / Flat 595) / skip 1593件
...
- 確定: 428件 (Win 143 / Loss 178 / Flat 107) / pending 0件 / skip 386件
...
- 更新: 2026-07-23T02:41:13.760581+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.11% price=65718.2
...
| symbol | 24h | volume |
|---|---:|---:|
| JIMOTHY/USDT:USDT | +53.00% | $5,919,384.20 |
| RIF/USDT:USDT | +33.96% | $4,968,848.37 |
| BANK/USDT:USDT | +29.62% | $109,420,099.62 |
| O/USDT:USDT | +26.06% | $4,739,130.43 |
| ZAMA/USDT:USDT | +20.41% | $3,832,915.28 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| BANK/USDT:USDT | below_1h_threshold | +3.31% | +3.42% |
| ZAMA/USDT:USDT | below_1h_threshold | +3.23% | +3.34% |
| DODO/USDT:USDT | below_1h_threshold | +3.22% | +3.33% |
| SKYAI/USDT:USDT | below_1h_threshold | +3.09% | +3.20% |
| TRIA/USDT:USDT | below_1h_threshold | +2.76% | +2.87% |
