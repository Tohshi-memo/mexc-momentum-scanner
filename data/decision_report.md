...
- generated_at: 2026-08-04T14:11:44.203263+00:00
...
- 更新: 2026-08-04T14:11:33.486224+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h +0.08% price=63713.2
- Funnel: target 937 → liquid 179 → pre 50 → checked 50 → surge 4 → strict 0
- Surge前reject: below_1h_threshold=46, below_relative_strength=0, invalid_ohlcv=0, errors=0
- Strict後reject: 4h RSI 80.8 >= 65=1, 4h RSI 92.5 >= 65=1, 4h RSI 72.6 >= 65=1, 4h RSI 79.8 >= 65=1
...
| symbol | 24h | volume |
|---|---:|---:|
| CYS/USDT:USDT | +68.11% | $11,557,977.42 |
| HOME/USDT:USDT | +44.97% | $13,429,559.30 |
| SKYAI/USDT:USDT | +37.41% | $43,542,438.79 |
| CASHCAT/USDT:USDT | +36.48% | $1,178,473.85 |
| BANK/USDT:USDT | +35.24% | $15,705,451.54 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| BANK/USDT:USDT | below_1h_threshold | +3.80% | +3.73% |
| KORU/USDT:USDT | below_1h_threshold | +3.41% | +3.33% |
| SNXX/USDT:USDT | below_1h_threshold | +3.19% | +3.11% |
| MRVLSTOCK/USDT:USDT | below_1h_threshold | +3.14% | +3.07% |
| ORCLSTOCK/USDT:USDT | below_1h_threshold | +2.77% | +2.69% |
