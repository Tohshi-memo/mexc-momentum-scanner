...
- generated_at: 2026-07-09T16:58:22.128634+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **8530**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +1.18% / filled 20/20。**
- 全期間 MARKET基準: n=8530, expectancy=-0.01%
...
| LIMIT_4PCT_LONG | 12/20 | 60.0% | -0.19% | **-0.12%** |
...
- 確定: 2718件 (Win 859 / Loss 912 / Flat 947) / skip 2373件
- 成長率目線: 平均log +0.000427 / 幾何平均 +0.043% per trade / maxDD +8.13%
- 次の候補: `MARKET_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: VELVET/USDT:USDT `MARKET_LONG` EXPIRED account -0.16% 残高後 $319.13

## 4. Robust Adaptive DryRun ($100)

- 残高: **$105.11** / 初期 $100.00 (+5.11%)
- 確定: 642件 (Win 152 / Loss 159 / Flat 331) / skip 1299件
...
- 更新: 2026-07-09T16:58:16.979432+00:00 / 保存件数 288/288
