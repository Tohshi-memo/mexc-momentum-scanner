...
- generated_at: 2026-08-21T21:01:25.372026+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **12259**

## 1. 今日の判断

- 結論: **実行可能なMARKET SHORTは安全条件未達。LIMIT/LONGはシャドウで測り、実行側対応まではlive portfolioへ流さない。**
- 全期間 MARKET基準: n=12259, expectancy=-0.00%
...
| LIMIT_6PCT | 6/20 | 30.0% | +5.96% | **+1.79%** |
...
- 確定: 4381件 (Win 1341 / Loss 1437 / Flat 1603) / skip 4439件
- 成長率目線: 平均log +0.000429 / 幾何平均 +0.043% per trade / maxDD +8.46%
- 次の候補: `LIMIT_1PCT_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: BASECAT/USDT:USDT `LIMIT_3PCT_LONG` EXPIRED account +0.00% 残高後 $656.41

## 4. Robust Adaptive DryRun ($100)

- 残高: **$156.48** / 初期 $100.00 (+56.48%)
- 確定: 1866件 (Win 515 / Loss 445 / Flat 906) / skip 3804件
...
- 更新: 2026-08-21T21:01:13.330932+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.06% price=77435.0
...
| symbol | 24h | volume |
|---|---:|---:|
| BASECAT/USDT:USDT | +222.57% | $2,346,864.14 |
| CATE/USDT:USDT | +33.62% | $10,679,379.13 |
| JIMOTHY/USDT:USDT | +25.42% | $1,498,401.69 |
| MAGMA/USDT:USDT | +12.25% | $2,048,869.08 |
| GALA/USDT:USDT | +10.06% | $9,325,046.26 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| BASECAT/USDT:USDT | below_1h_threshold | +1.40% | +1.46% |
| ZEN/USDT:USDT | below_1h_threshold | +1.33% | +1.39% |
| ONG/USDT:USDT | below_1h_threshold | +0.93% | +0.99% |
| DASH/USDT:USDT | below_1h_threshold | +0.50% | +0.56% |
| ROBO/USDT:USDT | below_1h_threshold | +0.49% | +0.54% |
