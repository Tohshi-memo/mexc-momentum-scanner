...
- 全期間 MARKET基準: n=9664, expectancy=-0.02%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_BB3S | 8/17 | 47.1% | +2.58% | **+1.21%** |
...
| LIMIT_4PCT_LONG | 11/20 | 55.0% | +1.35% | **+0.74%** |
...
- 確定: 3435件 (Win 1088 / Loss 1118 / Flat 1229) / skip 2790件
...
- 確定: 1224件 (Win 338 / Loss 275 / Flat 611) / skip 1851件
...
- 確定: 684件 (Win 222 / Loss 261 / Flat 201) / pending 3件 / skip 447件
...
- 最新: ESPORTS/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account +0.00% 残高後 $108.12
