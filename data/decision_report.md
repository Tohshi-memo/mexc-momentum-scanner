...
- 全期間 MARKET基準: n=5972, expectancy=-0.04%
...
| LIMIT_BB3S | 6/16 | 37.5% | -0.10% | **-0.04%** |
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_3PCT_LONG | 12/20 | 60.0% | +5.51% | **+3.31%** |
| LIMIT_4PCT_LONG | 11/20 | 55.0% | +5.67% | **+3.12%** |
| LIMIT_BB3S_LONG | 2/4 | 50.0% | +6.12% | **+3.06%** |
| LIMIT_ATR_LONG | 13/20 | 65.0% | +4.48% | **+2.91%** |
...
- 確定: 1089件 (Win 264 / Loss 328 / Flat 497) / skip 1444件
