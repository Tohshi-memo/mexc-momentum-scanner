...
- 全期間 MARKET基準: n=9349, expectancy=-0.01%
...
| LIMIT_2PCT | 14/20 | 70.0% | +1.11% | **+0.78%** |
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_5PCT_LONG | 12/20 | 60.0% | +0.57% | **+0.34%** |
| LIMIT_7PCT_LONG | 9/20 | 45.0% | +0.62% | **+0.28%** |
| LIMIT_6PCT_LONG | 11/20 | 55.0% | +0.44% | **+0.24%** |
...
- 確定: 3320件 (Win 1048 / Loss 1075 / Flat 1197) / skip 2590件
...
- 確定: 1161件 (Win 312 / Loss 254 / Flat 595) / skip 1599件
