...
- 全期間 MARKET基準: n=14494, expectancy=-0.01%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_FIB1272 | 10/20 | 50.0% | +1.69% | **+0.85%** |
...
- 確定: 5434件 (Win 1635 / Loss 1762 / Flat 2037) / skip 5621件
...
- 確定: 2991件 (Win 830 / Loss 716 / Flat 1445) / skip 4914件
- 成長率目線: 平均log +0.000275 / 幾何平均 +0.028% per trade / maxDD +3.96%
- 次の候補: `LIMIT_2PCT_LONG` (selected_by_robust_growth_score) / robust_score +0.0475 / risk 0.35% / cost 0.15% / daily stop 1.5% / DD stop 8.0%
- 最新: CATE/USDT:USDT `LIMIT_2PCT_LONG` SL_HIT account -0.35% 残高後 $227.62

## 5. Causal Adaptive DryRun ($100)

- 残高: **$126.83** / 初期 $100.00 (+26.83%)
- 確定: 2875件 (Win 857 / Loss 1112 / Flat 906) / pending 3件 / skip 3086件
...
- 最新: ARK/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account +0.00% 残高後 $126.83
