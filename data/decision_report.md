...
- generated_at: 2026-07-18T22:51:21.854045+00:00
...
- 全期間 MARKET基準: n=8984, expectancy=+0.00%
...
| LIMIT_ATR_LONG | 8/20 | 40.0% | +3.49% | **+1.40%** |
...
- 確定: 3049件 (Win 946 / Loss 973 / Flat 1130) / skip 2496件
...
- 確定: 945件 (Win 235 / Loss 191 / Flat 519) / skip 1450件
- 成長率目線: 平均log +0.000189 / 幾何平均 +0.019% per trade / maxDD +3.89%
...
- 更新: 2026-07-18T22:51:09.447380+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h +0.08% price=64750.0
...
| symbol | 24h | volume |
|---|---:|---:|
| ESPORTS/USDT:USDT | +62.57% | $27,559,271.42 |
| BANK/USDT:USDT | +39.68% | $18,791,579.04 |
| TLM/USDT:USDT | +26.88% | $1,746,010.27 |
| B/USDT:USDT | +16.81% | $31,159,607.81 |
| AKE/USDT:USDT | +13.91% | $84,142,639.42 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| LIT/USDT:USDT | below_1h_threshold | +2.85% | +2.77% |
| BILL/USDT:USDT | below_1h_threshold | +2.75% | +2.67% |
| FARTCOIN/USDT:USDT | below_1h_threshold | +1.79% | +1.71% |
| TRADOOR/USDT:USDT | below_1h_threshold | +1.16% | +1.08% |
| WLD/USDT:USDT | below_1h_threshold | +0.94% | +0.86% |
