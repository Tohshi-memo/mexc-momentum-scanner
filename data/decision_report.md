...
- 全期間 MARKET基準: n=13381, expectancy=+0.00%
...
- 確定: 4991件 (Win 1514 / Loss 1635 / Flat 1842) / skip 4951件
...
- 確定: 2360件 (Win 666 / Loss 569 / Flat 1125) / skip 4432件
- 成長率目線: 平均log +0.000260 / 幾何平均 +0.026% per trade / maxDD +3.96%
- 次の候補: `LIMIT_2PCT_LONG` (selected_by_robust_growth_score) / robust_score +0.1462 / risk 0.35% / cost 0.15% / daily stop 1.5% / DD stop 8.0%
- 最新: AKE/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account +0.00% 残高後 $184.71

## 5. Causal Adaptive DryRun ($100)

- 残高: **$114.58** / 初期 $100.00 (+14.58%)
- 確定: 2095件 (Win 611 / Loss 820 / Flat 664) / pending 4件 / skip 2755件
...
- 最新: AKE/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account +0.00% 残高後 $114.58
