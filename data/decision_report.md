...
- generated_at: 2026-08-06T10:56:37.602223+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **10578**

## 1. 今日の判断

- 結論: **実行可能なMARKET SHORTは安全条件未達。LIMIT/LONGはシャドウで測り、実行側対応まではlive portfolioへ流さない。**
- 全期間 MARKET基準: n=10578, expectancy=-0.02%
...
| LIMIT_ATR | 12/20 | 60.0% | +1.78% | **+1.07%** |
...
- 確定: 3795件 (Win 1203 / Loss 1249 / Flat 1343) / skip 3344件
...
- 確定: 1412件 (Win 393 / Loss 332 / Flat 687) / skip 2577件
...
- 最新: HFT/USDT:USDT `LIMIT_6PCT` EXPIRED account +0.00% 残高後 $142.71
...
- 更新: 2026-08-06T10:56:23.970898+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.11% price=64577.7
- Funnel: target 955 → liquid 192 → pre 50 → checked 50 → surge 5 → strict 1
- Surge前reject: below_1h_threshold=45, below_relative_strength=0, invalid_ohlcv=0, errors=0
- Strict後reject: 4h RSI 84.6 >= 65=1, 4h RSI 74.7 >= 65=1, 4h RSI 71.7 >= 65=1, 4h RSI 65.8 >= 65=1
...
| symbol | 24h | volume |
|---|---:|---:|
| HEI/USDT:USDT | +72.90% | $71,817,699.24 |
| BLESS/USDT:USDT | +55.59% | $123,824,519.72 |
| CTSI/USDT:USDT | +47.53% | $1,319,670.73 |
| TAKE/USDT:USDT | +44.26% | $1,515,665.06 |
| ZBT/USDT:USDT | +42.15% | $2,846,687.57 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| CAP/USDT:USDT | below_1h_threshold | +4.52% | +4.64% |
| RESOLV/USDT:USDT | below_1h_threshold | +4.25% | +4.36% |
| BTW/USDT:USDT | below_1h_threshold | +3.35% | +3.47% |
| HOME/USDT:USDT | below_1h_threshold | +3.19% | +3.30% |
| CATE/USDT:USDT | below_1h_threshold | +3.00% | +3.11% |
