...
- generated_at: 2026-09-04T17:36:37.692140+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **13650**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +0.41% / filled 20/20。**
- 全期間 MARKET基準: n=13650, expectancy=-0.00%
...
| LIMIT_2PCT_LONG | 13/20 | 65.0% | +0.23% | **+0.15%** |
...
- 確定: 5011件 (Win 1516 / Loss 1644 / Flat 1851) / skip 5200件
...
- 確定: 2420件 (Win 682 / Loss 577 / Flat 1161) / skip 4641件
...
- 確定: 2290件 (Win 678 / Loss 881 / Flat 731) / pending 6件 / skip 2831件
...
- 最新: 4/USDT:USDT `MARKET_LONG` EXPIRED account +0.17% 残高後 $116.99

## 6. Latest Market Context

- 更新: 2026-09-04T17:36:23.487483+00:00 / 保存件数 288/288
- BTC: BULLISH 1h -0.29% price=79474.9
...
| symbol | 24h | volume |
|---|---:|---:|
| 4/USDT:USDT | +25.63% | $1,575,974.97 |
| SKR/USDT:USDT | +10.22% | $6,617,705.50 |
| BONER/USDT:USDT | +9.85% | $2,035,840.90 |
| TUT/USDT:USDT | +8.22% | $1,418,537.84 |
| USELESS/USDT:USDT | +6.22% | $44,695,355.60 |
...
| BONER/USDT:USDT | below_1h_threshold | +1.92% | +2.21% |
| DASH/USDT:USDT | below_1h_threshold | +1.74% | +2.03% |
| CAP/USDT:USDT | below_1h_threshold | +1.64% | +1.93% |
