...
- 全期間 MARKET基準: n=12487, expectancy=+0.01%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_ATR | 13/20 | 65.0% | +3.30% | **+2.14%** |
| MARKET | 20/20 | 100.0% | +2.08% | **+2.08%** |
| LIMIT_1PCT | 17/20 | 85.0% | +2.36% | **+2.00%** |
| LIMIT_BB3S | 5/17 | 29.4% | +3.49% | **+1.03%** |
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_5PCT_LONG | 15/20 | 75.0% | +1.24% | **+0.93%** |
| LIMIT_7PCT_LONG | 11/20 | 55.0% | +1.56% | **+0.86%** |
| LIMIT_6PCT_LONG | 13/20 | 65.0% | +1.04% | **+0.67%** |
| LIMIT_FIB1272_LONG | 17/20 | 85.0% | +0.70% | **+0.59%** |
...
- 確定: 4509件 (Win 1375 / Loss 1477 / Flat 1657) / skip 4539件
...
- 確定: 1963件 (Win 536 / Loss 469 / Flat 958) / skip 3935件
...
- 最新: 1000RATS/USDT:USDT `LIMIT_5PCT` EXPIRED account +0.00% 残高後 $157.26
