...
- generated_at: 2026-08-09T09:51:16.189675+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **10995**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +2.60% / filled 20/20。**
- 全期間 MARKET基準: n=10995, expectancy=-0.01%
...
- 確定: 3931件 (Win 1230 / Loss 1281 / Flat 1420) / skip 3625件
...
- 確定: 1512件 (Win 424 / Loss 360 / Flat 728) / skip 2894件
...
- 更新: 2026-08-09T09:51:09.424391+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.01% price=64785.6
- Funnel: target 961 → liquid 153 → pre 50 → checked 50 → surge 2 → strict 0
- Surge前reject: below_1h_threshold=48, below_relative_strength=0, invalid_ohlcv=0, errors=0
- Strict後reject: 4h RSI 96.9 >= 65=1, 4h RSI 67.9 >= 65=1
...
| symbol | 24h | volume |
|---|---:|---:|
| TUT/USDT:USDT | +124.28% | $63,406,973.04 |
| BMT/USDT:USDT | +82.57% | $2,351,170.00 |
| COOKIE/USDT:USDT | +28.43% | $5,070,685.18 |
| IOTX/USDT:USDT | +25.76% | $6,171,171.89 |
| MUBARAK/USDT:USDT | +24.52% | $2,207,632.40 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| CASHCAT/USDT:USDT | below_1h_threshold | +3.80% | +3.81% |
| XAI/USDT:USDT | below_1h_threshold | +3.15% | +3.16% |
| BILL/USDT:USDT | below_1h_threshold | +2.93% | +2.94% |
| BEAT/USDT:USDT | below_1h_threshold | +1.66% | +1.67% |
| IOTX/USDT:USDT | below_1h_threshold | +1.65% | +1.66% |
