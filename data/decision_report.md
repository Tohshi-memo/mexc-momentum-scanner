...
- generated_at: 2026-07-14T07:06:07.521474+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **8677**

## 1. 今日の判断

- 結論: **実行可能なMARKET SHORTは安全条件未達。LIMIT/LONGはシャドウで測り、実行側対応まではlive portfolioへ流さない。**
- 全期間 MARKET基準: n=8677, expectancy=-0.00%
...
- 確定: 2845件 (Win 891 / Loss 924 / Flat 1030) / skip 2393件
- 成長率目線: 平均log +0.000420 / 幾何平均 +0.042% per trade / maxDD +8.13%
- 次の候補: `LIMIT_FIB1272_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: BILL/USDT:USDT `LIMIT_6PCT` EXPIRED account +0.00% 残高後 $330.71

## 4. Robust Adaptive DryRun ($100)

- 残高: **$104.98** / 初期 $100.00 (+4.98%)
- 確定: 675件 (Win 159 / Loss 161 / Flat 355) / skip 1413件
...
- 最新: BILL/USDT:USDT `LIMIT_6PCT` EXPIRED account +0.00% 残高後 $104.98

## 5. Causal Adaptive DryRun ($100)

- 残高: **$98.75** / 初期 $100.00 (-1.25%)
- 確定: 58件 (Win 19 / Loss 39 / Flat 0) / pending 1件 / skip 87件
...
- 最新: BILL/USDT:USDT `MARKET` SL_HIT account -0.17% 残高後 $98.75

## 6. Latest Market Context

- 更新: 2026-07-14T07:06:01.745343+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.00% price=62597.3
...
| symbol | 24h | volume |
|---|---:|---:|
| AIOT/USDT:USDT | +34.76% | $7,692,641.16 |
| TRIA/USDT:USDT | +28.75% | $2,823,750.52 |
| ZBT/USDT:USDT | +21.33% | $3,132,707.41 |
| SXT/USDT:USDT | +18.17% | $2,218,080.70 |
| EVAA/USDT:USDT | +16.37% | $21,466,946.07 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| SXT/USDT:USDT | below_1h_threshold | +4.87% | +4.87% |
| BILL/USDT:USDT | below_1h_threshold | +1.27% | +1.27% |
| USOIL/USDT:USDT | below_1h_threshold | +1.17% | +1.17% |
| UKOIL/USDT:USDT | below_1h_threshold | +1.03% | +1.03% |
