...
- generated_at: 2026-09-02T06:21:28.468351+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **13314**

## 1. 今日の判断

- 結論: **実行可能なMARKET SHORTは安全条件未達。LIMIT/LONGはシャドウで測り、実行側対応まではlive portfolioへ流さない。**
- 全期間 MARKET基準: n=13314, expectancy=+0.01%
...
- 確定: 4941件 (Win 1503 / Loss 1625 / Flat 1813) / skip 4934件
- 成長率目線: 平均log +0.000429 / 幾何平均 +0.043% per trade / maxDD +8.46%
- 次の候補: `LIMIT_2PCT_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: FONE/USDT:USDT `LIMIT_FIB1272_LONG` EXPIRED account +0.00% 残高後 $832.89

## 4. Robust Adaptive DryRun ($100)

- 残高: **$174.81** / 初期 $100.00 (+74.81%)
- 確定: 2293件 (Win 637 / Loss 549 / Flat 1107) / skip 4432件
...
- 更新: 2026-09-02T06:21:14.591000+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.05% price=77577.2
...
| symbol | 24h | volume |
|---|---:|---:|
| FONE/USDT:USDT | +56.26% | $1,551,987.87 |
| MAGMA/USDT:USDT | +35.08% | $5,713,055.96 |
| CASHCAT/USDT:USDT | +26.14% | $1,481,214.28 |
| UAI/USDT:USDT | +20.47% | $20,966,225.07 |
| BONER/USDT:USDT | +19.72% | $2,639,723.35 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| ACE/USDT:USDT | below_1h_threshold | +2.60% | +2.65% |
| BTW/USDT:USDT | below_1h_threshold | +1.23% | +1.28% |
| SKR/USDT:USDT | below_1h_threshold | +1.15% | +1.20% |
| AKE/USDT:USDT | below_1h_threshold | +0.82% | +0.88% |
| ARB/USDT:USDT | below_1h_threshold | +0.62% | +0.67% |
