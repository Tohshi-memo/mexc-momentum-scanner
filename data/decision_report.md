...
- 全期間 MARKET基準: n=12196, expectancy=-0.00%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_BB3S_LONG | 6/8 | 75.0% | +4.81% | **+3.60%** |
| LIMIT_1PCT_LONG | 18/20 | 90.0% | +1.60% | **+1.44%** |
| MARKET_LONG | 20/20 | 100.0% | +1.08% | **+1.08%** |
| LIMIT_ATR_LONG | 13/20 | 65.0% | +1.56% | **+1.01%** |
...
- 確定: 4362件 (Win 1337 / Loss 1434 / Flat 1591) / skip 4395件
...
- 確定: 1823件 (Win 502 / Loss 429 / Flat 892) / skip 3784件
- 成長率目線: 平均log +0.000237 / 幾何平均 +0.024% per trade / maxDD +3.96%
- 次の候補: `LIMIT_2PCT_LONG` (selected_by_robust_growth_score) / robust_score +0.0640 / risk 0.35% / cost 0.15% / daily stop 1.5% / DD stop 8.0%
