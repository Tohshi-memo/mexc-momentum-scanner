...
- generated_at: 2026-07-16T00:36:13.219659+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **8778**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +2.02% / filled 20/20。**
- 全期間 MARKET基準: n=8778, expectancy=+0.01%
...
- 確定: 2895件 (Win 906 / Loss 942 / Flat 1047) / skip 2444件
- 成長率目線: 平均log +0.000423 / 幾何平均 +0.042% per trade / maxDD +8.13%
- 次の候補: `LIMIT_7PCT` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: HOME/USDT:USDT `LIMIT_7PCT` EXPIRED account +0.00% 残高後 $340.65

## 4. Robust Adaptive DryRun ($100)

- 残高: **$107.10** / 初期 $100.00 (+7.10%)
- 確定: 742件 (Win 170 / Loss 168 / Flat 404) / skip 1447件
...
- 最新: HOME/USDT:USDT `LIMIT_7PCT` EXPIRED account +0.00% 残高後 $107.10
...
- 次の候補: `MARKET` (selected_by_causal_log_growth) / causal_score +0.000480 / risk 0.175% / cost 0.15% / batch最大 2件 / open risk上限 1.05% / DD stop 8.0%
- 最新: XEC/USDT:USDT `LIMIT_2PCT_LONG` EXPIRED account -0.09% 残高後 $98.49

## 6. Latest Market Context

- 更新: 2026-07-16T00:36:05.814231+00:00 / 保存件数 288/288
- BTC: BULLISH 1h -0.28% price=64540.6
...
| symbol | 24h | volume |
|---|---:|---:|
| HOME/USDT:USDT | +20.31% | $1,905,979.12 |
| ROAM/USDT:USDT | +18.08% | $5,610,729.02 |
| CAP/USDT:USDT | +15.15% | $1,698,400.84 |
| ONDO/USDT:USDT | +9.06% | $42,716,435.94 |
| LDO/USDT:USDT | +8.90% | $6,676,443.60 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| VELVET/USDT:USDT | below_1h_threshold | +3.90% | +4.18% |
| ETHFI/USDT:USDT | below_1h_threshold | +1.87% | +2.15% |
| T/USDT:USDT | below_1h_threshold | +1.65% | +1.93% |
| BANK/USDT:USDT | below_1h_threshold | +1.60% | +1.88% |
| USELESS/USDT:USDT | below_1h_threshold | +1.60% | +1.88% |
