...
- generated_at: 2026-08-31T13:51:32.651533+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **13176**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +2.54% / filled 20/20。**
- 全期間 MARKET基準: n=13176, expectancy=+0.02%
...
|---|---:|---:|---:|---:|
| MARKET | 20/20 | 100.0% | +2.54% | **+2.54%** |
| LIMIT_1PCT | 17/20 | 85.0% | +1.77% | **+1.50%** |
...
- 確定: 4876件 (Win 1485 / Loss 1609 / Flat 1782) / skip 4861件
...
- 確定: 2173件 (Win 603 / Loss 528 / Flat 1042) / skip 4414件
...
- 最新: SKR/USDT:USDT `LIMIT_5PCT` SL_HIT account +0.07% 残高後 $173.38

## 5. Causal Adaptive DryRun ($100)

- 残高: **$115.89** / 初期 $100.00 (+15.89%)
- 確定: 2084件 (Win 610 / Loss 812 / Flat 662) / pending 0件 / skip 2562件
...
- 更新: 2026-08-31T13:51:23.020229+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.05% price=77861.5
- Funnel: target 1028 → liquid 156 → pre 50 → checked 50 → surge 2 → strict 0
- Surge前reject: below_1h_threshold=48, below_relative_strength=0, invalid_ohlcv=0, errors=0
- Strict後reject: 4h RSI 77.0 >= 65=1, 4h RSI 72.4 >= 65=1
...
| symbol | 24h | volume |
|---|---:|---:|
| SKR/USDT:USDT | +75.72% | $56,616,543.53 |
| HEMI/USDT:USDT | +44.15% | $8,437,297.67 |
| BASECAT/USDT:USDT | +33.90% | $2,074,000.14 |
| ZORA/USDT:USDT | +32.68% | $15,156,746.28 |
| PONS/USDT:USDT | +29.46% | $2,224,461.72 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| SKYAI/USDT:USDT | below_1h_threshold | +3.66% | +3.71% |
| ZORA/USDT:USDT | below_1h_threshold | +2.78% | +2.83% |
| JASMY/USDT:USDT | below_1h_threshold | +1.78% | +1.83% |
| DESTOCK/USDT:USDT | below_1h_threshold | +1.73% | +1.78% |
| USELESS/USDT:USDT | below_1h_threshold | +1.43% | +1.48% |
