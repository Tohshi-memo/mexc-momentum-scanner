...
- 全期間 MARKET基準: n=14915, expectancy=-0.00%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_2PCT_LONG | 17/20 | 85.0% | +3.16% | **+2.69%** |
| LIMIT_ATR_LONG | 14/20 | 70.0% | +2.69% | **+1.88%** |
| LIMIT_3PCT_LONG | 12/20 | 60.0% | +2.89% | **+1.73%** |
| LIMIT_BB3S_LONG | 6/15 | 40.0% | +3.64% | **+1.46%** |
| LIMIT_4PCT_LONG | 10/20 | 50.0% | +2.19% | **+1.09%** |
...
- 確定: 5606件 (Win 1679 / Loss 1816 / Flat 2111) / skip 5870件
...
- 確定: 3173件 (Win 878 / Loss 757 / Flat 1538) / skip 5153件
- 成長率目線: 平均log +0.000278 / 幾何平均 +0.028% per trade / maxDD +3.96%
- 次の候補: `LIMIT_2PCT_LONG` (selected_by_robust_growth_score) / robust_score +0.0730 / risk 0.35% / cost 0.15% / daily stop 1.5% / DD stop 8.0%
