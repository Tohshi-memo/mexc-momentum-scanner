...
- generated_at: 2026-07-21T05:06:18.914878+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **9154**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +1.31% / filled 20/20。**
- 全期間 MARKET基準: n=9154, expectancy=-0.01%
...
- 残高: **$418.85** / 初期 $100.00 (+318.85%)
- 確定: 3216件 (Win 1009 / Loss 1024 / Flat 1183) / skip 2499件
- 成長率目線: 平均log +0.000445 / 幾何平均 +0.045% per trade / maxDD +8.13%
- 次の候補: `LIMIT_1PCT_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: ESPORTS/USDT:USDT `LIMIT_1PCT_LONG` EXPIRED account +0.63% 残高後 $418.85

## 4. Robust Adaptive DryRun ($100)

- 残高: **$130.77** / 初期 $100.00 (+30.77%)
- 確定: 1115件 (Win 295 / Loss 232 / Flat 588) / skip 1450件
...
- 最新: ESPORTS/USDT:USDT `LIMIT_1PCT_LONG` EXPIRED account +0.43% 残高後 $130.77
...
- 更新: 2026-07-21T05:06:11.878923+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.03% price=65472.3
...
| symbol | 24h | volume |
|---|---:|---:|
| JIMOTHY/USDT:USDT | +86.59% | $3,064,661.08 |
| ERA/USDT:USDT | +67.34% | $4,284,044.65 |
| ZHIPUSTOCK/USDT:USDT | +28.58% | $1,757,014.22 |
| ESPORTS/USDT:USDT | +13.68% | $5,336,067.02 |
| LDO/USDT:USDT | +11.08% | $8,129,940.45 |

### Near Miss

| symbol | reason | 1h | RS |
|---|---|---:|---:|
| ERA/USDT:USDT | below_1h_threshold | +1.34% | +1.37% |
| ADA/USDT:USDT | below_1h_threshold | +0.99% | +1.02% |
| ESPORTS/USDT:USDT | below_1h_threshold | +0.91% | +0.94% |
| VVV/USDT:USDT | below_1h_threshold | +0.72% | +0.76% |
| USELESS/USDT:USDT | below_1h_threshold | +0.68% | +0.71% |
