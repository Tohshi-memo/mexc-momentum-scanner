...
- 全期間 MARKET基準: n=15519, expectancy=+0.01%
...
| LIMIT_ATR | 16/20 | 80.0% | +1.34% | **+1.07%** |
| LIMIT_3PCT | 14/20 | 70.0% | +1.37% | **+0.96%** |
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_5PCT_LONG | 11/20 | 55.0% | +2.99% | **+1.65%** |
| LIMIT_4PCT_LONG | 13/20 | 65.0% | +1.30% | **+0.84%** |
| LIMIT_6PCT_LONG | 8/20 | 40.0% | +1.64% | **+0.66%** |
| LIMIT_BB3S_LONG | 8/9 | 88.9% | +0.56% | **+0.49%** |
| LIMIT_ATR_LONG | 17/20 | 85.0% | +0.55% | **+0.47%** |
...
- 確定: 5901件 (Win 1740 / Loss 1890 / Flat 2271) / skip 6179件
...
- 確定: 3452件 (Win 951 / Loss 793 / Flat 1708) / skip 5478件
...
- 最新: SYN/USDT:USDT `LIMIT_6PCT` EXPIRED account +0.00% 残高後 $254.57
