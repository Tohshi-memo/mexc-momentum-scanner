...
- 全期間 MARKET基準: n=12181, expectancy=-0.00%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_BB3S_LONG | 6/9 | 66.7% | +5.38% | **+3.58%** |
| LIMIT_FIB1272_LONG | 9/20 | 45.0% | +2.75% | **+1.24%** |
| LIMIT_8PCT_LONG | 8/20 | 40.0% | +2.00% | **+0.80%** |
| LIMIT_ATR_LONG | 15/20 | 75.0% | +0.78% | **+0.58%** |
...
- 確定: 4361件 (Win 1337 / Loss 1434 / Flat 1590) / skip 4381件
...
- 確定: 1823件 (Win 502 / Loss 429 / Flat 892) / skip 3769件
- 成長率目線: 平均log +0.000237 / 幾何平均 +0.024% per trade / maxDD +3.96%
- 次の候補: `LIMIT_6PCT` (selected_by_robust_growth_score) / robust_score +0.0628 / risk 0.35% / cost 0.15% / daily stop 1.5% / DD stop 8.0%
- 最新: CATE/USDT:USDT `LIMIT_7PCT` EXPIRED account +0.00% 残高後 $154.16

## 5. Causal Adaptive DryRun ($100)

- 残高: **$117.00** / 初期 $100.00 (+17.00%)
- 確定: 1823件 (Win 540 / Loss 692 / Flat 591) / pending 1件 / skip 1832件
