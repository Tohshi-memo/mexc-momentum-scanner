...
- generated_at: 2026-06-15T01:54:35.974064+00:00
- source: `data/experiments.json` + archive=True
- closed shadow trades: **6722**

## 1. 今日の判断

- 結論: **MARKET SHORTは実行候補。直近EV +0.87% / filled 20/20。**
- 全期間 MARKET基準: n=6722, expectancy=-0.04%
...
- 確定: 1595件 (Win 423 / Loss 499 / Flat 673) / skip 1688件
- 成長率目線: 平均log +0.000351 / 幾何平均 +0.035% per trade / maxDD +7.25%
- 次の候補: `LIMIT_9PCT_LONG` (selected_by_recent_avg_log_return) / risk 0.50% / daily stop 2.0% / DD stop 10.0%
- 最新: RIF/USDT:USDT `LIMIT_FIB1272_LONG` TP_HIT account +1.00% 残高後 $175.11

## 4. Robust Adaptive DryRun ($100)

- 残高: **$99.53** / 初期 $100.00 (-0.47%)
- 確定: 90件 (Win 22 / Loss 15 / Flat 53) / skip 43件
...
- 更新: 2026-06-15T01:54:30.817961+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h -0.16% price=65487.5
...
| symbol | 24h | volume |
|---|---:|---:|
| OPG/USDT:USDT | +32.66% | $7,900,146.47 |
| EVAA/USDT:USDT | +27.71% | $16,610,810.55 |
| RIF/USDT:USDT | +21.67% | $5,235,456.66 |
| CLO/USDT:USDT | +19.82% | $1,686,437.29 |
| H/USDT:USDT | +18.35% | $131,919,202.82 |
...
| EVAA/USDT:USDT | below_1h_threshold | +3.11% | +3.27% |
| RIF/USDT:USDT | below_1h_threshold | +2.81% | +2.97% |
| WLD/USDT:USDT | below_1h_threshold | +2.59% | +2.75% |
| MITO/USDT:USDT | below_1h_threshold | +2.21% | +2.37% |
