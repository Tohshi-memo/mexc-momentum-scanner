...
- 全期間 MARKET基準: n=12195, expectancy=-0.00%
...
| strategy | filled/total | fill率 | avg PnL | 実質EV |
|---|---:|---:|---:|---:|
| LIMIT_BB3S_LONG | 7/9 | 77.8% | +5.26% | **+4.09%** |
| LIMIT_1PCT_LONG | 18/20 | 90.0% | +1.10% | **+0.99%** |
| LIMIT_ATR_LONG | 14/20 | 70.0% | +1.16% | **+0.81%** |
...
- 確定: 4362件 (Win 1337 / Loss 1434 / Flat 1591) / skip 4394件
...
- 確定: 1823件 (Win 502 / Loss 429 / Flat 892) / skip 3783件
