...
- generated_at: 2026-07-19T16:51:20.954735+00:00
...
- 確定: 256件 (Win 88 / Loss 128 / Flat 40) / pending 5件 / skip 267件
...
- 更新: 2026-07-19T16:51:09.780528+00:00 / 保存件数 288/288
- BTC: STAGNANT 1h +0.02% price=64560.7
- Funnel: target 885 → liquid 128 → pre 50 → checked 49 → surge 3 → strict 1
- Surge前reject: below_1h_threshold=46, below_relative_strength=0, invalid_ohlcv=0, errors=1
- Strict後reject: 4h RSI 78.1 >= 65=2
...
| symbol | 24h | volume |
|---|---:|---:|
| BANK/USDT:USDT | +13.54% | $58,956,089.24 |
| TLM/USDT:USDT | +9.01% | $11,810,183.62 |
| DEXE/USDT:USDT | +7.45% | $1,375,504.99 |
| SYN/USDT:USDT | +4.31% | $3,619,146.02 |
| ESPORTS/USDT:USDT | +4.11% | $64,324,090.37 |
...
| ESPORTS/USDT:USDT | below_1h_threshold | +3.88% | +3.85% |
| VANRY/USDT:USDT | below_1h_threshold | +3.08% | +3.06% |
| BLESS/USDT:USDT | below_1h_threshold | +2.89% | +2.87% |
| BASED/USDT:USDT | below_1h_threshold | +2.06% | +2.03% |
