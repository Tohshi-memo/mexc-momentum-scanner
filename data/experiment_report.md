...
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL candidates | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
| STRICT (current) | 0 | – | – | – | – | – | – | – |
| REJECTED by STRICT | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| RSI ≥ 60 | 13 | 5/8/0 | 38.5% | +10.37% | -4.00% | +1.53% | +19.8% | 0.4h |
...
| 4h RSI < 75 | 12 | 4/8/0 | 33.3% | +9.62% | -4.00% | +0.54% | +6.5% | 0.6h |
| OFF (no 4h filter) | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
...
| BB break NOT required (all) | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
| BB no-break only | 16 | 7/9/0 | 43.8% | +10.38% | -4.00% | +2.29% | +36.6% | 0.5h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL volume trends | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
| NOT RISING (current) | 19 | 8/11/0 | 42.1% | +10.26% | -4.00% | +2.00% | +38.1% | 0.5h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| rel strength ≥ 0% | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
| rel strength ≥ 3% | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
| rel strength ≥ 5% | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
...
| STAGNANT | 12 | 5/7/0 | 41.7% | +9.68% | -4.00% | +1.70% | +20.4% | 0.5h |
...
| LOW | 0 | – | – | – | – | – | – | – |
| AVOID | 0 | – | – | – | – | – | – | – |
| UNKNOWN | 20 | 8/12/0 | 40.0% | +10.26% | -4.00% | +1.70% | +34.1% | 0.5h |
...
|-----------|------------|--------------|-------|
| RSI(1h) | +71.42 | +65.84 | +5.58 |
| RSI(4h) | +76.77 | +67.29 | +9.48 |
| price/BB upper | +0.93 | +0.93 | +0.00 |
| volume ratio | +0.76 | +0.63 | +0.13 |
| ATR% | +8.09 | +6.95 | +1.14 |
| change_1h | +9.11 | +7.40 | +1.71 |
| rel strength | +9.34 | +7.46 | +1.88 |
