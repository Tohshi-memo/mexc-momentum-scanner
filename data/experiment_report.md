...
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL candidates | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| STRICT (current) | 0 | – | – | – | – | – | – | – |
| REJECTED by STRICT | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| RSI ≥ 60 | 3 | 0/3/0 | 0.0% | +0.00% | -4.00% | -4.00% | -12.0% | 0.4h |
| RSI ≥ 65 | 3 | 0/3/0 | 0.0% | +0.00% | -4.00% | -4.00% | -12.0% | 0.4h |
| RSI ≥ 70 | 3 | 0/3/0 | 0.0% | +0.00% | -4.00% | -4.00% | -12.0% | 0.4h |
...
| OFF (no 4h filter) | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
...
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| BB break required | 0 | – | – | – | – | – | – | – |
| BB break NOT required (all) | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| BB no-break only | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL volume trends | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| NOT RISING (current) | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| DECLINING only (strictest) | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| FLAT only | 0 | – | – | – | – | – | – | – |
| RISING only | 0 | – | – | – | – | – | – | – |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| rel strength ≥ 0% | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| rel strength ≥ 3% | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| rel strength ≥ 5% | 4 | 1/3/0 | 25.0% | +8.06% | -4.00% | -0.98% | -3.9% | 0.5h |
| rel strength ≥ 7% | 3 | 1/2/0 | 33.3% | +8.06% | -4.00% | +0.02% | +0.1% | 0.6h |
| rel strength ≥ 10% | 0 | – | – | – | – | – | – | – |
...
| RSI≥70 & ¬RISING (no 4h) | 3 | 0/3/0 | 0.0% | +0.00% | -4.00% | -4.00% | -12.0% | 0.4h |
...
|-----------|------------|--------------|-------|
| RSI(1h) | +59.53 | +77.34 | -17.81 |
| RSI(4h) | +66.59 | +85.52 | -18.93 |
| price/BB upper | +0.90 | +0.91 | -0.01 |
| volume ratio | +0.43 | +0.49 | -0.06 |
| ATR% | +7.72 | +7.33 | +0.39 |
| change_1h | +5.18 | +6.14 | -0.96 |
| rel strength | +7.52 | +6.61 | +0.91 |
| btc 1h change | -2.34 | -0.47 | -1.87 |
