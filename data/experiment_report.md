...
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL candidates | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| STRICT (current) | 0 | – | – | – | – | – | – | – |
| REJECTED by STRICT | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| RSI ≥ 60 | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| RSI ≥ 65 | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| RSI ≥ 70 | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
...
| 4h RSI < 70 | 0 | – | – | – | – | – | – | – |
| 4h RSI < 75 | 0 | – | – | – | – | – | – | – |
| OFF (no 4h filter) | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
...
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| BB break required | 0 | – | – | – | – | – | – | – |
| BB break NOT required (all) | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| BB no-break only | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| ALL volume trends | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| NOT RISING (current) | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| DECLINING only (strictest) | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| FLAT only | 0 | – | – | – | – | – | – | – |
| RISING only | 0 | – | – | – | – | – | – | – |
...
| group | n | W/L/E | win% | avg win | avg loss | expectancy | total PnL | median hold |
|-------|---|-------|------|---------|----------|------------|-----------|-------------|
| rel strength ≥ 0% | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| rel strength ≥ 3% | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| rel strength ≥ 5% | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| rel strength ≥ 7% | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
| rel strength ≥ 10% | 0 | – | – | – | – | – | – | – |
...
| RSI≥70 & ¬RISING (no 4h) | 1 | 0/1/0 | 0.0% | +0.00% | -4.00% | -4.00% | -4.0% | 0.4h |
